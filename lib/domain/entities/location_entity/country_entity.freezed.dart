...
mixin _$CountryEntity {
  List<Datacountry> get data => throw _privateConstructorUsedError;
...
abstract class $CountryEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Datacountry> data});
}
...
class _$_CountryEntity implements _CountryEntity {
  _$_CountryEntity({required final List<Datacountry> data}) : _data = data;
  ...
  @override
  String toString() {
    return 'CountryEntity(data: $data)';
  }
...
abstract class _CountryEntity implements CountryEntity {
  factory _CountryEntity({required final List<Datacountry> data}) =
      _$_CountryEntity;

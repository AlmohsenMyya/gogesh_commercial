...
class ForgetPasswordUseCase extends UseCase<String, ForgetPasswordRequest> {
  ...
  @override
  Future<Result<String, Exceptions>> call(ForgetPasswordRequest params) async {
    try {
      final keyLanguage = localDataSource.getValue(LocalDataKeys.languageKey);

      final result = await dataSource.forgetpassword(
          forgetPasswordRequest: params, language: keyLanguage);

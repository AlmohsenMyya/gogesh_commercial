...
class FetchSectionUseCase implements UseCase<StandarPaginated, Filter> {
  final CategoriesRemoteDataSource remoteDataSource;

  FetchSectionUseCase(this.remoteDataSource);
  ...
  Future<Result<StandarPaginated, Exceptions>> call(Filter params) async {
    try {
      ...
      final result = await remoteDataSource.getSectionByService(
          language: keyLanguage, queries: params.toJson(), id: params.id!);

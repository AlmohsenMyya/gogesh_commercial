...
class FetchOccasionsUseCase implements UseCase<StandarPaginated, Filter> {
 final CategoriesRemoteDataSource remoteDataSource;

  FetchOccasionsUseCase(this.remoteDataSource);
 ...
 @override
  Future<Result<StandarPaginated , Exceptions>> call(Filter params) async {
    try {
      ...
      final result = await remoteDataSource.getSeasons(

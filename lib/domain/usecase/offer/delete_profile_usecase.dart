...
class DeleteOffersUseCase extends UseCase<String, ModelID> {
  final OfferRemoteDataSource dataSource;
  final LocalDataSource localDataSource;

  DeleteOffersUseCase({required this.dataSource, required this.localDataSource});
  @override
  Future<Result<String, Exceptions>> call(
    ...
    try {
      ...
      final result = await dataSource.deleteOffers(
          language: keyLanguage, auth: token, id: params.id, body: FormData.fromMap({
            "_method":'delete',
          }));

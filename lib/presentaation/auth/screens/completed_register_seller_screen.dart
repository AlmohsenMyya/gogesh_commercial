                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const Text("Commercial_activity_department").tr(),
                              SizedBox(
                                height: 0.5.h,
                              ),
                              SearchDropDownWidget<StandarEntity>(
                  ...
                  SizedBox(
                    ...
                    child: custombuttom(
                      onTap: () async {
                        ...
                        if (activityId == null) {
                          AlertController.show("",
                              "please_choose_activity".tr(), TypeAlert.warning);
                          return;
                        }
                        ...
                        if (sectorId == null) {
                          AlertController.show("", "please_choose_sector".tr(),
                              TypeAlert.warning);
                          return;
                        }
                        ...
                        if (typeCompanty == "Company" && lisence.isEmpty) {
                          AlertController.show(
                              "",
                              "Please_upload_a_copy_of_the_commercial_license".tr(),
                              TypeAlert.warning);
                        }
                        if (typeCompanty == "Company" && signature.isEmpty) {
                          AlertController.show(
                              "",
                              "Please_upload_a_copy_of_the_signature_approval".tr(),
                              TypeAlert.warning);
                        }
                        ...
                        if (_formKey.currentState!.validate()) {
                          context.read<AuthBloc>().add(
                                AuthEvent.registerPrimary(
                                  request: RegisterPrimarySeller(
                                      ...
                                      description: descriptionCommercial.text,
                                      nameCommercial: nameCommercial.text,
                                      phoneCommercial: "Dz-+212-0653685856",
                          ...
                          sl<LocalDataSource>().setValue(
                              LocalDataKeys.role, TypeSeller.admin.name);
                        } else if (gender == null) {
                          AlertController.show(
                              "", "Choose_the_gender".tr(), TypeAlert.warning);
                          return;
                        } else if (!isChecked!) {
                          AlertController.show(
                              "",

...
class FilterOfferWidget extends StatelessWidget {
  const FilterOfferWidget({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<FilterOfferCubit<ServiceTypeEnum>, ServiceTypeEnum?>(
            ...
            children: [
              FilterChip(
                ...
                onSelected: (bool value) {
                  context
                      .read<FilterOfferCubit<ServiceTypeEnum>>()
                      .changeItem(null);
                },
              ),
              SizedBox(

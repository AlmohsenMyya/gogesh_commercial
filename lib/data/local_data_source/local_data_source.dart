...
class InformationEntityAdapter extends TypeAdapter<InformationEntity> {
  ...
  InformationEntity read(BinaryReader reader) {
    ...
    return InformationEntity(
      ...
      adsDiscount: fields[16] as int?,
      maxAdsPerNotification: fields[12] as int?,
      maxAdsViaSectorBanner: fields[15] as int?,
      maxFreeAds: fields[13] as int?,
      maxOfferChange: fields[7] as int?,
      offerAdditionCost: fields[6] as int?,
      maxOffers: fields[5] as int?,
      maxSpecialties: fields[9] as int?,
      offerChangeCost: fields[8] as int?,
      maxUsers: fields[14] as int?,
      notificationCost: fields[11] as int?,
      specialtyAdditionCost: fields[10] as int?,
    );
  }
